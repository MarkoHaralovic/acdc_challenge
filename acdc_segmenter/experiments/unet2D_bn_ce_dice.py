...
experiment_name = 'unet2D_bn_ce_dice'
...
momentum = None
loss_type = 'crossentropy_and_dice'  # crossentropy/weighted_crossentropy/dice/dice_onlyfg/focal/crossentropy_boundary_aware
